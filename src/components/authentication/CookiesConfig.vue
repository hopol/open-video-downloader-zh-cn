  ...
  >
    ...
    <span class="label mb-2 gap-1">
      <i18n-t keypath="auth.cookies.file.hint" scope="global">
        <template #link>
          <a href="https://github.com/hopol/open-video-downloader-zh-cn/blob/main/docs/COOKIE-AUTHENTICATION.zh-CN.md#cookie-身份验证说明" class="link" target="_blank" rel="noopener">
    ...
    <span class="label mb-2 gap-1">
      <i18n-t keypath="auth.cookies.browser.hint" scope="global">
        <template #link>
          <a href="https://github.com/hopol/open-video-downloader-zh-cn/blob/main/docs/COOKIE-AUTHENTICATION.zh-CN.md#支持的浏览器读取方式" class="link" target="_blank" rel="noopener">
